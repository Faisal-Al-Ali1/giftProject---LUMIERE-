    ...
    if (snapshot.exists()) {
      ...
      Object.entries(data).forEach(([key, favorite]) => {
        ...
        row.innerHTML = `
          ...
          <td>
            <button class="add-to-cart-btn" data-id="${key}">Proceed</button>
          </td>
        `;
        ...
        // إضافة حدث تحقق عند الضغط على زر Proceed
